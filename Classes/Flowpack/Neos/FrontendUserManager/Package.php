<?php
namespace Flowpack\Neos\FrontendUserManager;
...
class Package extends BasePackage {
	...
	public function boot(Bootstrap $bootstrap) {
		...
		$dispatcher->connect('TYPO3\Flow\Configuration\ConfigurationManager', 'configurationManagerReady', function(ConfigurationManager $configurationManager) {
			$settings = $configurationManager->getConfiguration(ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'Flowpack.Neos.FrontendUserManager');
